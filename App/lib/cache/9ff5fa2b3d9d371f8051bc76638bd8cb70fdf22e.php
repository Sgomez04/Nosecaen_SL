...
<?php $__env->startSection('link'); ?>
    ...
    <link rel="stylesheet" href="<?= ASSETS_URL ?>css/<?php echo e($_SESSION['theme']); ?>/profile.css" />
...
<?php $__env->startSection('nav'); ?>
    ...
    <?php endif; ?>
    <a href="<?php echo e(BASE_URL); ?>profile?idU=<?php echo e($_SESSION['id']); ?>" class="nav-item nav-link active"><i
        ...
        <div class="jumbotron">
            <div class="row">
                <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
                    <img src="<?php echo e(ASSETS_URL); ?>img/logo2.png" alt="stack photo" class="img">
                </div>
                <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                    ...
                    <a aria-label='Thanks' class='h-button centered bton' data-text='Editar datos'
                        href="<?php echo e(BASE_URL); ?>edit-profile?idU=<?php echo e($_REQUEST['idU']); ?>&eprofile=1">
                        <span>C</span>
                        <span>l</span>
                        <span>i</span>
                        <span>c</span>
