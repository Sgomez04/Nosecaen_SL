...
@section('cuerpo')
    ...
    <form id="frm-tarea" action="add?id={{ $id }}" method="post">
        ...
        <div class="form-group">
            <p> Persona de contacto: <input type="text" name="persona" class="form-control" value="{{ $persona }}"
                    placeholder="Nombre del contratante" /> </p>
        </div>

        <div class="form-group">
            <p> Teléfono/s contacto: <input type="text" name="telefono" class="form-control" value="{{ $telefono }}"
                    placeholder="Telefono del contratante" /> </p>
        </div>

        <div class="form-group">
            <p> Descripción: <input type="text" name="descripcion" class="form-control" value="{{ $desc }}"
                    placeholder="Descripcion de la tarea" /> </p>
        </div>

        <div class="form-group">
            <p> Correo electrónico: <input type="text" name="correo" class="form-control" value="{{ $correo }}"
                    placeholder="Correo del contratante" /> </p>
        </div>

        <div class="form-group">
            <p> Direccion: <input type="text" name="direccion" class="form-control" value="{{ $direccion }}"
                    placeholder="Direccion de la tarea a realizar" /> </p>
        </div>

        <div class="form-group">
            <p> Poblacion: <input type="text" name="poblacion" class="form-control" value="{{ $poblacion }}"
                    placeholder="Poblacion de la tarea a realizar" /> </p>
        </div>

        <div class="form-group">
            <p> Codigo Postal: <input type="text" name="cp" class="form-control" value="{{ $cp }}"
        ...
        <div class="form-group">
            <p> Fecha de creacion de la tarea: <input type="text" name="fcreacion" class="form-control"
                    value="{{ $fcreacion }}" placeholder="Fecha obtenida del sistema" readonly /> </p>
        </div>

        <div class="form-group">
            <p> Operario encargado: <input type="text" name="operario" class="form-control" value="{{ $operario }}"
                    placeholder="Operario encargado de la tarea" /> </p>
        </div>

        <div class="form-group">
            <p> Fecha de realización: <input type="text" name="fechaR" value="{{ $frealizacion }}"
                    class="form-control datepicker" placeholder="Fecha de realizacion de la tarea" /> </p>
        </div>

        <div class="form-group">
            <p> Anotaciones anteriores: <input type="text" name="aa" class="form-control" value="{{ $aa }}"
                    placeholder="Anotacion anterior a la realizacion de la tarea" /> </p>
        </div>

        <div class="form-group">
            <p> Anotaciones posteriores: <input type="text" name="ap" class="form-control" value="{{ $ap }}"
                    placeholder="Anotacion anterior a la realizacion de la tarea" /> </p>
        </div>
