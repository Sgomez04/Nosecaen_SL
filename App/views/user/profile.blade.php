...
@section('nav')
    ...
    <a href="{{BASE_URL}}profile?idU={{$_SESSION['id']}}" class="nav-item nav-link active"><i class="fa fa-user"></i><span> Perfil</span></a>
        ...
        <div class="jumbotron">
            <div class="row">
                <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
                    <img src="{{ ASSETS_URL }}img/logo2.png"
                ...
                <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                    ...
                    <br>
                    <a aria-label='Thanks' class='h-button centered bton' data-text='Editar datos' href="{{BASE_URL}}edit-profile?idU={{$_REQUEST['idU']}}&eprofile=1">
                        <span>C</span>
                        <span>l</span>
                        <span>i</span>
                        <span>c</span>
